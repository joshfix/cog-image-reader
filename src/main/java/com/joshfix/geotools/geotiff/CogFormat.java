package com.joshfix.geotools.geotiff;
 ...
 */
public class CogFormat extends AbstractGridFormat implements Format {

    /**
     * Logger.
     */
    private static final Logger LOGGER =
            org.geotools.util.logging.Logging.getLogger(CogFormat.class);
    ...
    /**
     * Creates a new instance of CogFormat
     */
    public CogFormat() {
    ...
    public boolean accepts(Object o, Hints hints) {
        ...
        try {
            ...
            MathTransform raster2Model = CogReader.parseWorldFile(o);
            if (raster2Model == null) {
                MapInfoFileReader mif = CogReader.parseMapInfoFile(o);
                if (mif != null) {
     ...
     */
    @Override
    public CogReader getReader(Object source) {
     ...
     */
    @Override
    public CogReader getReader(Object source, Hints hints) {
        ...
        if (source instanceof URL) {
            ...
            try {
                ...
                return new CogReader(url, hints);
        ...
        try {
            return new CogReader(source, hints);
        } catch (DataSourceException e) {
            if (LOGGER.isLoggable(Level.WARNING))
                LOGGER.log(Level.WARNING, e.getLocalizedMessage(), e);
            return null;
