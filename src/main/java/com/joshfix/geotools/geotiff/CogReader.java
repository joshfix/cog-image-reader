 ...
 * @since 2.1
 */
public class CogReader extends AbstractGridCoverage2DReader implements GridCoverage2DReader {
    ...
    private static final ImageReaderSpi READER_SPI = new CogImageReaderSpi();
     ...
     */
    public CogReader(Object input) throws DataSourceException {
